...
//-------------------------------------------------------------------------------------------//
class HomeScreenSubCategory extends StatefulWidget {
  static String tag = 'HomeScreenSubCategory';
  final String value;
  final String value1;
  final String value2;
//-------------------------------------------------------------------------------------------//
  HomeScreenSubCategory({Key key, this.value, this.value1, this.value2}) : super(key: key);
  @override
  _HomeScreenSubCategoryItem createState() => new _HomeScreenSubCategoryItem();
}
//-------------------------------------------------------------------------------------------//
class _HomeScreenSubCategoryItem extends State<HomeScreenSubCategory> {
  List data;
  String categoryid;
  List<Posts> _list = [];
  List<Posts> _search = [];
