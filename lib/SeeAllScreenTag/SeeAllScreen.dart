...
class SeeAllScreen extends StatefulWidget {
  static String tag = 'SeeAllScreen';
  final String value;
//-------------------------------------------------------------------------------------------//
  SeeAllScreen({Key key, this.value}) : super(key: key);
  @override
  _SeeAllScreen createState() => new _SeeAllScreen();
}
//-------------------------------------------------------------------------------------------//
class _SeeAllScreen extends State<SeeAllScreen> {
  List data;
  String categoryid;
  List<Posts> _list = [];
  List<Posts> _search = [];
                      ...
                      child: new Column(
                        children: <Widget>[
                          new ListTile(
                            ...
                            title: new Text(
                              a.Cat_Name.toUpperCase(),textAlign: TextAlign.start,
...
//-------------------------------------------------------------------------------------------//
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(GlobalString.CATEGORY.toUpperCase(),style: TextStyle(color: ColorCode.TextColorCode),),
        centerTitle: true,
